...
public class Constants {
    ...
    public final static String DAILY_GRAPH = "daily-graph";
    public final static String WEEKLY_GRAPH = "weekly-graph";
    public final static String MONTHLY_GRAPH = "monthly-graph";
    public final static String YEARLY_GRAPH = "yearly-graph";
